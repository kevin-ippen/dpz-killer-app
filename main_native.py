"""
Main entry point for Databricks App with Native React Chat

This is a SIMPLIFIED version that:
1. Includes backend API routes (including new /api/chat/stream)
2. Serves frontend static assets
3. Provides SPA fallback for client-side routing

NO Chainlit mounting - just clean, simple routing!
"""
import sys
import os
import logging
...
from app.api.routes import chat_stream  # NEW: Native streaming chat
...
app.include_router(chat_stream.router, prefix="/api")  # NEW: Streaming chat
...
# ============================================================================
# That's it! ~130 lines vs 200+ with Chainlit mounting
# ============================================================================
